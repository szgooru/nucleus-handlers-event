...
public final class ResponseFactory {
  public static JsonObject generateItemCreateResponse(JsonObject body, JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response).setEventType(MessageConstants.EST_ITEM_CREATE).build();
  }

  public static JsonObject generateItemDeleteResponse(JsonObject body, JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response).setEventType(MessageConstants.EST_ITEM_DELETE).build();
  }

  public static JsonObject generateItemEditResponse(JsonObject body, JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response).setEventType(MessageConstants.EST_ITEM_EDIT).build();
  }

  public static JsonObject generateItemCopyResponse(JsonObject body, JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response).setEventType(MessageConstants.EST_ITEM_COPY).build();
  }

  public static JsonObject generateItemMoveResponse(JsonObject body, JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response).setEventType(MessageConstants.EST_ITEM_MOVE).build();
  }

  public static JsonObject generateItemReorderResponse(JsonObject body, JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response).setEventType(MessageConstants.EST_ITEM_REORDER).build();
  }

  public static JsonObject generateItemContentReorderResponse(JsonObject body, JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response).setEventType(MessageConstants.EST_ITEM_CONTENT_REORDER).build();
  }

  public static JsonObject generateItemCollaboratorUpdateResponse(JsonObject body, JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response).setEventType(MessageConstants.EST_ITEM_COLLABORATOR_UPDATE).build();
  }
