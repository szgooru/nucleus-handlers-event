...
class MessageProcessor implements Processor {
  ...
  public JsonObject process() {
    ...
    try {
      ...
      TRANSMIT_FAIL_LOGGER.error( ResponseFactory.generateErrorResponse((JsonObject) (message != null ? message.body() : null), message.headers()).toString() );
    }
    return result;
  }
  ...
  private JsonObject processEventResourceCreateUpdateCopy() {
    ...
    if (msgObject != null) {
      ...
      if (msgBody != null) {
        ...
        JsonObject result = RepoBuilder.buildContentRepo().getResource(contentId);
        if (result != null) {
  ...
  private JsonObject processEventResourceDelete() {
    ...
    if (msgObject != null) {
      ...
      if (msgBody != null) {
        ...
        JsonObject result = RepoBuilder.buildContentRepo().getDeletedResource(contentId);
        if (result != null) {
  ...
  private JsonObject processEventQuestionCreateUpdateCopy() {
    ...
    if (msgObject != null) {
      ...
      if (msgBody != null) {
        ...
        JsonObject result = RepoBuilder.buildContentRepo().getQuestion(contentId);
        if (result != null) {
  ...
  private JsonObject processEventQuestionDelete() {
    ...
    if (msgObject != null) {
      ...
      if (msgBody != null) {
        ...
        JsonObject result = RepoBuilder.buildContentRepo().getDeletedQuestion(contentId);
        if (result != null) {
  ...
  private JsonObject processEventCollectionCreateUpdateCopy() {
    ...
    if (msgObject != null) {
      ...
      if (msgBody != null) {
        ...
        JsonObject result = RepoBuilder.buildCollectionRepo().getCollection(contentId);
        if (result != null) {
  ...
  private JsonObject processEventAssessmentCreateUpdateCopy() {
    ...
    if (msgObject != null) {
      ...
      if (msgBody != null) {
        ...
        JsonObject result = RepoBuilder.buildCollectionRepo().getAssessment(contentId);
        if (result != null) {
