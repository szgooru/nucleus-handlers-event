...
public class ItemCreateUpdateCopyResponseObjectBuilder extends ResponseObject {

  public ItemCreateUpdateCopyResponseObjectBuilder(JsonObject body, JsonObject response) {
    super(body, response);
  }
  ...
  private JsonObject createPayLoadObjectStructure() {
    ...
    updateJsonForCULCInfo(payloadStructure);
